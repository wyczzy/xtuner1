...
# visual_encoder_name_or_path = '/data/kesun/wandb/run-20240715_154938-trlt8w7z/best_visual'# Specify the pretrained pth
...
# data_path = data_root + 'LLaVA-Pretrain/ffpp0608_wotest.json'
data_path = data_root + 'aigcdetect_progan_id_debug.json'
# data_path = data_root + 'pfig_caption.json'
# data_path = data_root + 'pfig_conversation.json'
# image_folder = "/data/kesun/kesun/Dataset/Dataset/Deepfake/ffpp"
