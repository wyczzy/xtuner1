...
def parse_args():
    ...
    parser.add_argument(
        '--div', action='store_true', help='')
    parser.add_argument(
        '--image-file', default=None, help='')
    parser.add_argument(
        '--answer-file', default=None, help='')
...
def main():
    ...
    if args.lagent:
        ...
        for img_file in tqdm(image_lines[args.start:args.end]):
            image = load_image(img_file.strip())
            image = expand2square(
            ...
            if args.div:
                try:
                    prompts_list = [
    "Can you identify if this image was created by AI or if it is real? Please provide your reasoning.",
    "Please assess whether this picture is a product of artificial intelligence or an actual creation, and explain why.",
    "Determine if this image is generated by AI or if it is genuine, and give your reasons.",
    "Could you tell if this image is AI-generated or real? Please explain your reasoning.",
    "Please evaluate whether this image is an AI creation or something real, and provide an explanation.",
    "Can you discern if this picture is made by AI or if it is real? Explain your reasoning.",
    "Please analyze whether this image is produced by AI or if it is real, and explain why.",
    "Determine whether this image is a result of AI generation or something real, and provide your reasoning.",
    "Can you figure out if this image is AI-generated or real? Please explain your reasoning.",
    "Please judge if this image is created by AI or if it is real, and explain the reason."
]

                except:
                    with open("/home/sk/zzy/LLaVA/playground/brief_prompts_div1.txt", "r", encoding="utf-8") as f:
                        prompts_list = f.readlines()
            else:
                try:
                    with open("/home/kesun/zzy/LLaVA/playground/brief_prompts.txt", "r", encoding="utf-8") as f:
                        prompts_list = f.readlines()
                except:
                    with open("/home/sk/zzy/LLaVA/playground/brief_prompts.txt", "r", encoding="utf-8") as f:
                        prompts_list = f.readlines()
            text = random.choice(prompts_list).strip()

            if img_file is not None and n_turn == 0:
            ...
            if img_file is None:
                ...
                try:
                    ...
                    ans_file.write(json.dumps({
                        "prompt": text,
                        "text": tokenizer.decode(generate_output[0]),
                        "image_path": img_file,
                    ...
                    ans_file.write(json.dumps({
                        "prompt": text,
                        "text": "probability tensor contains either `inf`, `nan` or element < 0",
                        "image_path": img_file,
                        "model_id": args.model_name_or_path,
                        "metadata": {}}) + "\n")
                    ans_file.flush()
